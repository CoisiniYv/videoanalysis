-- Migration 008: unified event, evidence, and algorithm-rule contracts.
--
-- This migration extends the existing event and camera configuration tables. It does not replace
