...
def summarize_artifact(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "adaface_decoupled": bool(config.get("adaface_decoupled")),
...
def markdown(summary: dict[str, Any]) -> str:
    lines = [
        ...
        "",
        "| run | stage | output | cpu | MPS | AdaFace async | face track ID | AdaFace queue | bbox crop | pre-gate | decoupled | timeout us | effective fps | steady/target | queue full | send failures | bundles |",
        "| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |",
    ]
    for row in summary["runs"]:
        lines.append(
            "| {run_id} | {stage} | {output_mode} | {cpu_profile} | {cuda_mps} | {adaface_classifier_async} | {face_secondary_track_id} | {adaface_input_queue} | {adaface_crop_resize} | {adaface_pre_gate} | {adaface_decoupled} | {batch_timeout_us} | "
