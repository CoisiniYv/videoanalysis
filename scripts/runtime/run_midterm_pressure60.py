    ...
    for key, path in paths.items():
        ...
        rolling_cache_publication_dispatcher_metrics = {
            ...
            for field in (
                ...
                "publication_commit_lock_wait_ms_total",
                "publication_commit_lock_wait_ms_max",
                "publication_commit_lock_wait_events_total",
                "publication_commit_lock_hold_ms_total",
                "publication_commit_lock_hold_ms_max",
