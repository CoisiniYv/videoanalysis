...
The pyfunc tolerates unknown ``rule_type`` values in cameras.yml — they are
logged and skipped — so a partial set is safe.
"""
...
from custom.rules import loitering  # noqa: F401
from custom.rules import running  # noqa: F401
